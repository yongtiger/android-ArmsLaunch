 ...
 */
package cc.brainbook.armscomponent.main.mvp.ui.activity;
...
import cc.brainbook.armscomponent.main.R;
import cc.brainbook.armscomponent.main.R2;
import cc.brainbook.armscomponent.commonsdk.core.RouterHub;
import cc.brainbook.armscomponent.commonsdk.utils.Utils;
import cc.brainbook.armscomponent.commonservice.gank.service.GankInfoService;
import cc.brainbook.armscomponent.commonservice.gold.service.GoldInfoService;
import cc.brainbook.armscomponent.commonservice.zhihu.service.ZhihuInfoService;
...
public class MainActivity extends BaseActivity {
    ///[改造ArmsComponent为app空壳]因为改造后，main模块与其它模块一样也拥有application和library两种运行模式
    ///原来只有一种application模式、butterknife为R，现在library模式应为R
